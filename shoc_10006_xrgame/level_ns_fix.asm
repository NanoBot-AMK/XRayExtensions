...
PERFORM_EXPORT_LEVEL__GO__U32					Level__GetSecondTalker,		"get_second_talker"
...
PERFORM_EXPORT_LEVEL__VECTOR__U32				Level__GetTriangleVertex1,	"get_tri_vertex1"
PERFORM_EXPORT_LEVEL__VECTOR__U32				Level__GetTriangleVertex2,	"get_tri_vertex2"
PERFORM_EXPORT_LEVEL__VECTOR__U32				Level__GetTriangleVertex3,	"get_tri_vertex3"
...
PERFORM_EXPORT_LEVEL__INT__STR_INT				Level__CreateExplosive,		"create_explosive"
PERFORM_EXPORT_LEVEL__U32__U32_VECTOR_FLOAT		Level__Explode,				"explode"
PERFORM_EXPORT_LEVEL__INT__INT					Level__DeleteExplosive,		"delete_explosive"
;------------< блокировка цифр(0..9) на основной клавиатуре. >-----------
PERFORM_EXPORT_LEVEL__VOID__VOID				Level__EnableInputNumbase,	"enable_input_numbase"
PERFORM_EXPORT_LEVEL__VOID__VOID				Level__DisableInputNumbase,	"disable_input_numbase"
;------------------------------------------------------------------------
...
PERFORM_EXPORT_LEVEL__VOID__U32					Level__SetTypeStatistic,	"set_type_statistic"
PERFORM_EXPORT_LEVEL__U32__VOID					Level__GetTypeStatistic,	"get_type_statistic"
...
;========CBulletExplosive========
align_proc
Level__CreateExplosive proc C name_section:dword, id_weapon:dword
	;return		(Level().BulletManager().CreateExplosive(name_section, id_weapon));
	mov		eax, ds:g_pGameLevel
	mov		edx, [eax]	; CLevel
	mov		ecx, [edx+m_pBulletManager]
	invoke	CBulletManager@@CreateExplosive, name_section, id_weapon
	ret
Level__CreateExplosive endp

align_proc
Level__Explode proc C id_explosive:dword, pos_x:dword, pos_y:dword, pos_z:dword, id_initiator:dword
...
align_proc
Level__DeleteExplosive proc C id_explosive:dword
	mov		edx, ds:g_pGameLevel
	mov		eax, [edx]	; CLevel
	mov		ecx, [eax+m_pBulletManager]
	invoke	CBulletManager@@DeleteExplosive, id_explosive
	ret
Level__DeleteExplosive endp

;;; (с) НаноБот
align 4
g_bDisableNumBaseInput	db false	; булева для блокировки цифр(0..9) на основной клавиатуре.
; заблокировать клавиатуру
align_proc
Level__EnableInputNumbase proc
	mov		g_bDisableNumBaseInput, false
	retn
Level__EnableInputNumbase endp

; разблокировать клавиатуру
align_proc
Level__DisableInputNumbase proc
	mov		g_bDisableNumBaseInput, true
	retn
Level__DisableInputNumbase endp

;Тип подсчёта статистики в КПК: 0 - подсчёт по штукам, 1 - подсчёт по очкам.
align_proc
Level__SetTypeStatistic proc C type_stat:dword
	mov		eax, type_stat
	test	eax, eax
	setnz	al
	...
	ret
Level__SetTypeStatistic endp

align_proc
Level__GetTypeStatistic proc
	mov		eax, [g_select_total_statistic]
	retn
Level__GetTypeStatistic endp
