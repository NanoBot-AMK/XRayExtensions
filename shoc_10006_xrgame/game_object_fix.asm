...
; -- to del
REGISTER_U32__STRING_INT		register_get_holder_int,				"get_holder_int"
;
...
; добавляем своё
	...
	PERFORM_EXPORT_U32__STRING_INT		  register_get_game_object_int,		   CScriptGameObject__GetGameObjectInt
	PERFORM_EXPORT_VOID__INT_INT		  register_set_game_object_int,		   CScriptGameObject__SetGameObjectInt
	PERFORM_EXPORT_U32__STRING_INT		  register_get_game_object_int16,	   CScriptGameObject__GetGameObjectInt16
	PERFORM_EXPORT_VOID__INT_INT		  register_set_game_object_int16,	   CScriptGameObject__SetGameObjectInt16
	PERFORM_EXPORT_U32__STRING_INT		  register_set_game_object_shared_str, CScriptGameObject__SetGameObjectSharedStr

	PERFORM_EXPORT_U32__STRING_INT		  register_get_actor_condition_int,	   CScriptGameObject__GetActorConditionInt
	...
	PERFORM_EXPORT_U32__STRING_INT		  register_get_car_int,				   CScriptGameObject__GetCarInt
	PERFORM_EXPORT_VOID__INT_INT		  register_set_car_int,				   CScriptGameObject__SetCarInt
	PERFORM_EXPORT_U32__STRING_INT		  register_get_car_int16,			   CScriptGameObject__GetCarInt16
	...
	PERFORM_EXPORT_U32__STRING_INT		  register_get_memory_int,			   CScriptGameObject__GetMemoryInt
	PERFORM_EXPORT_VOID__INT_INT		  register_set_memory_int,			   CScriptGameObject__SetMemoryInt
	PERFORM_EXPORT_U32__STRING_INT		  register_get_memory_int16,		   CScriptGameObject__GetMemoryInt16
	PERFORM_EXPORT_VOID__INT_INT		  register_set_memory_int16,		   CScriptGameObject__SetMemoryInt16
	PERFORM_EXPORT_U32__STRING_INT		  register_get_memory_int8,			   CScriptGameObject__GetMemoryInt8
	...
	PERFORM_EXPORT_U32__STRING_INT		  register_get_inventory_item_int,		  CScriptGameObject__GetInventoryItemInt
	PERFORM_EXPORT_VOID__INT_INT		  register_set_inventory_item_int,		  CScriptGameObject__SetInventoryItemInt
	PERFORM_EXPORT_U32__STRING_INT		  register_get_inventory_item_int16,	  CScriptGameObject__GetInventoryItemInt16
	PERFORM_EXPORT_VOID__INT_INT		  register_set_inventory_item_int16,	  CScriptGameObject__SetInventoryItemInt16
	PERFORM_EXPORT_U32__STRING_INT		  register_set_inventory_item_shared_str, CScriptGameObject__SetInventoryItemSharedStr
	...
	PERFORM_EXPORT_U32__STRING_INT register_get_actor_int, CScriptGameObject__GetActorInt
	PERFORM_EXPORT_U32__STRING_INT register_get_actor_int16, CScriptGameObject__GetActorInt16
	PERFORM_EXPORT_VOID__INT_INT register_set_actor_int, CScriptGameObject__SetActorInt

	PERFORM_EXPORT_U32__STRING_INT register_get_wpn_gl_int, CScriptGameObject__GetWeaponGLInt
	PERFORM_EXPORT_U32__STRING_INT register_get_wpn_int, CScriptGameObject__GetWeaponInt
	PERFORM_EXPORT_VOID__INT_INT register_set_wpn_int, CScriptGameObject__SetWeaponInt
	
	;PERFORM_EXPORT_U32__STRING_INT register_get_wpn_bone_id, CScriptGameObject__GetWeaponBoneID
	PERFORM_EXPORT_U32__STRING_INT register_get_bone_id, CScriptGameObject__GetBoneID
	
	;PERFORM_EXPORT_U32__STRING_INT register_get_wpn_hud_bone_id, CScriptGameObject__GetWeaponHudBoneID
	
	PERFORM_EXPORT_U32__STRING_INT register_get_hud_bone_id, CScriptGameObject__GetHudBoneID
	
	PERFORM_EXPORT_U32__STRING_INT register_set_wpn_bone_visible, CScriptGameObject__SetWeaponBoneVisible
	PERFORM_EXPORT_U32__STRING_INT register_set_hud_bone_visible, CScriptGameObject__SetHudBoneVisible
	PERFORM_EXPORT_U32__STRING_INT register_get_hud_bone_visible, CScriptGameObject__GetHudBoneVisible
	
	PERFORM_EXPORT_U32__STRING_INT register_get_wpn_bone_visible, CScriptGameObject__GetWeaponBoneVisible
	PERFORM_EXPORT_U32__STRING_INT register_get_bone_visible, CScriptGameObject__GetBoneVisible
	PERFORM_EXPORT_U32__STRING_INT register_set_bone_visible, CScriptGameObject__SetBoneVisible
	...
	PERFORM_EXPORT_U32__STRING_INT register_get_custom_monster_int, CScriptGameObject__GetCustomMonsterInt
	...
	PERFORM_EXPORT_U32__STRING_INT register_set_actor_shared_str, CScriptGameObject__SetActorSharedStr
	
	PERFORM_EXPORT_STRING__VOID CScriptGameObject__GetWpnSharedStr, "get_wpn_shared_str"
	PERFORM_EXPORT_U32__STRING_INT register_set_wpn_shared_str, CScriptGameObject__SetWpnSharedStr

	PERFORM_EXPORT_STRING__VOID CScriptGameObject__GetHudSharedStr, "get_hud_shared_str"
	PERFORM_EXPORT_U32__STRING_INT register_set_hud_shared_str, CScriptGameObject__SetHudSharedStr
	...
	PERFORM_EXPORT_U32__STRING_INT register_get_holder_int, CScriptGameObject__GetHolderInt
	...
	PERFORM_EXPORT_U32__STRING_INT register_save_hud_bone_float, CScriptGameObject__SaveHudBoneFloat
	...
	PERFORM_EXPORT_U32__STRING_INT		  register_get_inventory_item_int8,		   CScriptGameObject__GetInvItemInt8
	...
	PERFORM_EXPORT_U32__STRING_INT register_get_hud_animation_length, CScriptGameObject__GetHudAnimationLength
	; =========================================================================================
	; ======================================= END =============================================
	; =========================================================================================
	...
	PERFORM_EXPORT_BOOL__U32			register_get_key_state,				CScriptGameObject__GetKeyState
	PERFORM_EXPORT_U32__STRING_INT		register_spawn_artefact,			CScriptGameObject__SpawnArtefact
	;разрешить спавн артефактов аномалии скриптом.
	PERFORM_EXPORT_VOID__BOOL			CScriptGameObject__AllowScriptSpawnArtefact,	"allow_script_spawn_artefact"
	; идём обратно
...
;id_to = dword ptr	0Ch
	...
	movzx	eax, word ptr[ebp+12];id_to
	push	eax
	movzx	eax, word ptr[ebp+8];id_from
	push	eax
...
align_proc
CScriptGameObject__GetKeyState proc key:dword
	...
	ret		4
CScriptGameObject__GetKeyState endp

align_proc
CScriptGameObject__SpawnArtefact proc sect_art:dword, count:dword
local	pos1:Fvector, lvertex:dword
	push	esi
	push	edi
	push	ebx
	mov		eax, [ecx+4]
	smart_cast	_AVCCustomZone, _AVCGameObject, eax
	.if (eax)
	...
	pop		esi
	ret		8
CScriptGameObject__SpawnArtefact endp

align_proc
CScriptGameObject__AllowScriptSpawnArtefact proc on_spawn:byte
	mov		eax, [ecx+4]
	smart_cast	_AVCCustomZone, _AVCGameObject, eax
	.if (eax)
		ASSUME	eax:ptr CCustomZone
		mov		dl, on_spawn
		mov		[eax].m_bAllowScriptSpawnArtefact, dl
		ASSUME	eax:nothing
	.endif
	ret		4
CScriptGameObject__AllowScriptSpawnArtefact endp
