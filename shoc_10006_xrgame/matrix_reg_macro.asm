...
PERFORM_EXPORT__MATRIX__THIS__PMATR_PMATR MACRO registering_function:REQ, fun_to_export:REQ
	mov		ecx, eax
	xor		eax, eax
	lea		edi, [ebp-14h]
	stosb
...
PERFORM_EXPORT__MATRIX__PMATR__PVECTOR_PVECTOR_PVECTOR_PVECTOR MACRO registering_function:REQ, fun_to_export:REQ
	mov		ecx, eax
	xor		eax, eax
	lea		edi, [ebp-14h]
	stosb
...
arg_0			= dword ptr	 8
	...
	test	al, al
	pop		ecx
	jnz		short loc_1013A036
	push	4
	pop		eax
	mov		[ebp+var_8], offset sub_1013AA47
	mov		[ebp+var_10], offset sub_1030E428
	call	sub_100015E0
	cmp		eax, edi
	jz		short loc_1013A033
	mov		ecx, [ebp+var_4]
	mov		[eax], ecx
loc_1013A033:
	mov		[ebp+var_C], eax
loc_1013A036:
	...
	test	al, al
	pop		ecx
	jnz		short loc_1013A089
	push	4
	pop		eax
	mov		[ebp+var_8], offset sub_1013AA53
	mov		[ebp+var_10], offset sub_1030E428
	call	sub_100015E0
	cmp		eax, edi
	jz		short loc_1013A086
	mov		ecx, [ebp+var_4]
	mov		[eax], ecx
loc_1013A086:
	mov		[ebp+var_C], eax
...
register_fun_name endp
ENDM
just_return_false5 proc near
				xor		al, al
				retn
just_return_false5 endp
