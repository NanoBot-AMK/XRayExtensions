...
;.text:10018726                 mov     ecx, 30h
;.text:1001872B                 lea     esi, [ebx+4]
;.text:1001872E                 mov     edi, ebx
;.text:10018730                 rep movsd
;.text:10018732                 mov     ecx, [esp+1Ch+var_8]
;.text:10018736                 mov     [ebx+0C0h], eax
;.text:1001873C                 push    ecx
;.text:1001873D                 mov     edi, eax
;.text:1001873F                 mov     ecx, 30h
;.text:10018744                 mov     eax, ebp
...
;.text:10018A0E                 lea     esi, [ebp+5E8h]
;.text:10018A14                 mov     ebp, 0Ch
;.text:10018A19                 mov     [esp+1Ch+arg_8], 0Ch
;.text:10018A21                 xor     edi, edi
;.text:10018A23                 lea     ebx, [ebp-0Bh
cache_upd_6:
...
;.text:100240FE                 lea     edx, [ebp+4B80h]
offset_4:
	push ebp
...
;.text:1002416B                 lea     esi, [ebp+4C40h]
offset_5:
	push ebp
...
;.text:100241F2                 lea     esi, [ebp+7040h]
offset_6:
	push ebp
...
;.text:10024245                 lea     esi, [ebp+4B80h]
offset_7:
	push ebp
	add ebp, ds:[cache_first_el_offset]
	lea esi, [ebp]
...
;.text:100242F6                 mov     esi, [ebp+9688h]
offset_8:
	push ebp
	add ebp, ds:[cache_task_last_offset]
	mov esi, [ebp]
...
;.text:10024306                 cmp     [ebp+9688h], ecx
offset_9:
	push ebp
	add ebp, ds:[cache_task_last_offset]
	cmp [ebp], ecx
...
;.text:10024323                 mov     edi, [ebp+9688h]
;.text:10024329                 movss   [esp+1Ch+arg_C], xmm0
;.text:1002432F                 lea     edx, [ebp+7104h]
offset_10:
	push ebp
	add ebp, ds:[cache_task_last_offset]
	mov edi, [ebp]
...
;.text:100243BD                 mov     edx, [ebp+esi*4+7104h]
offset_11:
	push ebp
	add ebp, ds:[cache_task_first_offset]
	mov edx, [ebp+esi*4]
...
;.text:100243CB                 add     dword ptr [ebp+9688h], 0FFFFFFFFh
;.text:100243D2                 mov     ecx, [ebp+9688h]
offset_12:
	push ebp
	add ebp, ds:[cache_task_last_offset]
...
;.text:100243E0                 mov     ecx, [ebp+this*4+7108h]			this = eax
;.text:100243E7                 mov     [ebp+this*4+7104h], ecx
;.text:100243EE                 add     this, 1
;.text:100243F1                 cmp     this, [ebp+9688h]
offset_13:
	push ebp
...
;.text:10027DE2                 lea     ebp, [edx+eax+5C0h]
offset_15:
	push edx
...
;.text:10017314                 lea     eax, [eax+eax*2]
;.text:10017317                 add     eax, eax
;.text:10017319                 mov     [esp+298h+var_26C], 0
;.text:10017321                 mov     esi, [esp+298h+var_26C]
;.text:10017325                 add     eax, eax
